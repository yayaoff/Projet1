...
def print_infos(infos,file):
    ...
    with open('infos/'+file, 'w') as f:
        ...
        for key in infos.keys():
            if(key=='start' or key =='end' or key == 'requests' or key == 'tot_dns' or key == 'request ip type' or key == 'Ip versions' or key == 'tot' or key == 'tot time' or key == 'tot length' ):
                pass
            else:
                print('\n')
...
for file in os.listdir("data/"):
    ...
    tot_dom_names.append(len(infos.keys())-9)
...
fig_dom_name =  plt.figure(figsize=(15,10))
fig_dom_name = plt.title('Noms de domaine résolus selon la fonctionnalité',fontsize=25,fontweight ='bold')
fig_dom_name = plt.xlabel('Fonctionnalités', fontsize = 20)
fig_dom_name = plt.ylabel('Nombre de noms de domaine résolus', fontsize = 20)
...
fig_dom_name = plt.xticks(np.arange(len(tot_dom_names)),
        ['Chat','Enregistrement','Appel vidéo', 'Tableau \n blanc',"Partage \nd'écran","Chat \ndans l'appel",  'Réactions'], fontsize = 16)
...
fig_qry = plt.figure(figsize=(15,10))
fig_qry = plt.title('Type de requête adresse ip selon la fonctionnalité',fontsize=25,fontweight ='bold')
...
fig_qry = plt.xlabel('Fonctionnalités', fontsize = 20)
fig_qry = plt.ylabel('Nombre de requêtes', fontsize = 20)
...
fig_ipv = plt.figure(figsize=(15,10))
fig_ipv = plt.title('Version IP préférée par Zoom',fontsize=25,fontweight ='bold')
...
fig_ipv = plt.xlabel('Fonctionnalités', fontsize = 20)
fig_ipv = plt.ylabel('Nombre de requêtes adresse IP', fontsize = 20)
...
fig_qry = plt.figure(figsize=(15,10))
fig_qry = plt.title('Type de requête selon la fonctionnalité',fontsize=25,fontweight ='bold')
...
fig_tot_pckts = plt.figure(figsize=(15,10))
fig_tot_pckts = plt.title('Nombre de paquets echangés par minute selon la fonctionnalité',fontsize=25,fontweight ='bold')
fig_tot_pckts = plt.xlabel('Fonctionnalités', fontsize = 20)
fig_tot_pckts = plt.ylabel('Nombre de paquets par minute', fontsize = 20)
...
fig_tot_pckts = plt.figure(figsize=(15,10))
fig_tot_pckts = plt.title('Volume de données echangées par minute selon la fonctionnalité',fontsize=25,fontweight ='bold')
fig_tot_pckts = plt.xlabel('Fonctionnalités', fontsize = 20)
fig_tot_pckts = plt.ylabel('Volume de donneées [bytes/min]', fontsize = 20)
